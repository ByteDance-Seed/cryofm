...
from .upsampling import Upsample3D, upsample_3d
from .downsampling import Downsample3D, downsample_3d
...
class ResnetBlockCondNorm3D(nn.Module):
    ...
    Parameters:
        ...
        use_in_shortcut (`bool`, *optional*, default to `True`):
            If `True`, add a 1x1x1 nn.conv3d layer for skip-connection.
